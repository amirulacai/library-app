                            ...
                            <div class="module-body">
                                ...
                                <form class="form-horizontal row-fluid" action="edit_student_details.php?id=<?php echo $rollno ?>" method="post">
                                    ...
                                    <div class="control-group">
                                            ...
                                            <div class="controls">
                                            <select type="dropdown" id="Gender" name="Gender" value= "<?php echo $gender?>" class="span8" required>
...
$sql1="update LMS.user set Name='$name', Gender='$gender', EmailId='$email', MobNo='$mobno', Password='$pswd' where RollNo='$rollno'";
