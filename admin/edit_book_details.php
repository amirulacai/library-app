                                ...
                                ?>
                                    ...
                                    <form class="form-horizontal row-fluid" action="edit_book_details.php?id=<?php echo $bookid ?>" method="post">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select type="dropdown" id="Shelf" name="Shelf" value= "<?php echo $shelf?>" class="span8" required>
...
$sql1="update LMS.book set Title='$name', Author='$author', Publisher='$publisher', Year='$year', Shelf='$shelf', Availability='$avail' where BookId='$bookid'";
