                            ...
                            <div class="module-body">
                                    ...
                                    <form class="form-horizontal row-fluid" action="addbook.php" method="post">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="author" name="author" placeholder="Enter the Author Name" class="span8" required>
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="Shelf"><b>Shelf</b></label>
                                            <div class="controls">
                                                <select type="dropdown" id="shelf" name="shelf" placeholder="Shelf" class="span8" required>
...
$sql1="insert into LMS.book (Title,author,Publisher,Year,Shelf,Availability) values ('$title','$author','$publisher','$year','$shelf','$availability')";
