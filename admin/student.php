                            ...
                            ?>
                                    <tr>
                                      ...
                                      <td><?php echo $email ?></td>                                      
                                        <td>
                                        <center>
                                            <a href="studentdetails.php?id=<?php echo $rollno; ?>" class="btn btn-primary">Details</a>
                                            <a href="edit_student_details.php?id=<?php echo $rollno; ?>" class="btn btn-success">Edit</a>
